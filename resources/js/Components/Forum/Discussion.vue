    ...
    <Link :href="route('discussions.show', discussion)" class="block bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 flex items-center space-x-6">
            <div class="flex-grow">
                ...
                <Link :href="route('discussions.show', discussion)" class="inline-block text-sm mt-6">
            ...
            <div class="flex-shrink-0">
                <div class="flex items-center justify-start -space-x-1">
                    <img :src="participant.avatar_url" alt="" v-for="participant in discussion.participants"
                        :key="participant.id" class="h-6 w-6 rounded-full ring-2 ring-white first-of-type:w-7 first-of-type:h-7"
